...
function validarRegistro(){
    ...
    var fn = document.querySelector("#fnRegistro").value;
    var clave = document.querySelector("#claveRegistro").value;
    var numero = document.querySelector("#numeroRegistro").value;
    ...
    //Valirdar Usuario
        if(nombre!=''){
            if(nombre.length > 15){
                ...
                "<br>Por favor escriba solo 10 caracteres";
                return false;
            }
