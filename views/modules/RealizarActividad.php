      ...
      <div class="col">
        <form method="post" class="form">
          ...
          foreach ($datosPregunta as $keyPregunta => $valuePregunta) {
            print '<input type="text" name="idPregunta[]" value="'.$valuePregunta['idPreguntas'].'">';
          ...
          /////RESPUESTAS FALSO O VERDADERO ////////////
              if(count($datosRespuesta) == 1){
                ...
                <input type="radio" name="respuesta'.$valuePregunta['idPreguntas'].'" value="'.$valueRespuesta['idRespuestas'].'" class="form-control">';
              }
