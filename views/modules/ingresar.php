        ...
        <div class="tab-pane" id="messages">
          ...
          <form method="post" class="form-signin" onsubmit="return validarRegistro();" class="formulario">
            <div class="row">
              <div class="col">
                <h6>Nombres</h6>
                <input type="text" class="form-control" name="nombreRegistro" id="nombreRegistro" placeholder="Ingrese Maximo 25 caracteres" maxlength="25" required="">
              </div>
              <div class="col">
                <h6>Apellidos</h6>
                <input type="text" class="form-control" name="claveRegistro" id="claveRegistro" placeholder="Maximo 25 caracteres" maxlength="25" required="">
              </div>
            </div>
